...
public:
        ...
        static void init() {
#ifdef BOARD_LBW_DEV  
                USB_SPI.begin(48,6,7,3); //老霸王开发板，我加的
#else
...
#undef MAKE_PIN
#elif defined(BOARD_LBW_DEV)  //老霸王开发板，我加的
typedef SPi< P48, P7, P6, P3 > spi;
...
void MAX3421e< SPI_SS, INTR >::regWr(uint8_t reg, uint8_t data) {
        ...
        USB_SPI.beginTransaction(SPISettings(26000000, MSBFIRST, SPI_MODE0)); //26000000 The MAX3421E can handle up to 26MHz, use MSB First and SPI mode 0
#endif
        SPI_SS::Clear();
